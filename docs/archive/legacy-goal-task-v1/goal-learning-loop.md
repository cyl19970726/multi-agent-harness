...
> **Historical compatibility governance.** This remains relevant to legacy Goal
> ledgers and reusable-case experiments, but it is not the universal Company OS
> action chain. New work starts from Documents and WorkItems, uses risk-based
> Approvals, and may optionally select Mission/Wave execution. See
