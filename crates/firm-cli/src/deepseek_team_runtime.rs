...
fn callback_error(error: crate::CliError) -> harness_provider_deepseek::DeepSeekError {
...
pub(crate) struct DeepSeekTeamRuntime(harness_provider_deepseek::DeepSeekTeamRuntime);
...
impl rt::TeamRuntimeAdapter for DeepSeekTeamRuntime {
    ...
    fn capability_bindings() -> Vec<rt::CapabilityBinding> {
        harness_provider_deepseek::DeepSeekTeamRuntime::capability_bindings()
    }
    ...
    fn project_live(event: &serde_json::Value) -> Option<(rt::LiveProviderActivityKind, String)> {
        harness_provider_deepseek::DeepSeekTeamRuntime::project_live(event)
    }
...
impl rt::RuntimeAdapter for DeepSeekTeamRuntime {
