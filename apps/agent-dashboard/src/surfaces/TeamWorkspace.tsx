...
export function TeamWorkspace({apiUrl,space,project,teamId,teamRunId,refreshKey,selection,onAction,actionsCurrent,agentWorkspaceActionsEnabled=actionsCurrent,onSelectionChange}:{apiUrl:string;space:string;project:string;teamId:string;teamRunId?:string;refreshKey?:string;selection:SelectionState;onAction:RoleActionExecutor;actionsCurrent:boolean;agentWorkspaceActionsEnabled?:boolean;onSelectionChange:(next:Partial<SelectionState>)=>void}){
  ...
  if(conversationOpen) return <AgentConversationWorkspace apiUrl={apiUrl} space={space} project={project} routeIdentity={teamId} selection={selection} refreshKey={refreshKey} onAction={onAction} actionsEnabled={agentWorkspaceActionsEnabled} onSelectionChange={onSelectionChange}/>;
