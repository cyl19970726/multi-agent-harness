...
//!
//! Authority and atomicity of the migration itself live in
//! `work_responsibility_migration_authority.rs`; the fixtures both binaries
//! share live in `work_responsibility_fixtures/`.
...
use firm_core::agentfirm_api::{
    ...
    PermissionCeiling, RuntimeCommandBinding, RuntimeDispatchMode, RuntimeDriverRef,
    TeamMembership, TeamMembershipRole, TeamMembershipStatus, TrustErrorCode, WorkExecutionBinding,
    WorkExecutionBindingStatus,
};
use firm_core::{
    MemberRunStatus, ProviderRuntimeProjection, WorkEventKind, WorkPhase,
    WorkResponsibilityResolution,
};
use firm_store::CanonicalMemberRunAdmission;
