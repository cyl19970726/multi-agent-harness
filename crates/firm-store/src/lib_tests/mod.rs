...
#[cfg(any())]
mod delivery_projection_folds_cross_file_updates_by_store_sequence;
...
#[cfg(any())]
mod historical_provider_receipt_does_not_lock_later_work_revisions;
...
mod legacy_work_delivery_adapter_is_explicit_read_only_and_never_implies_non_delivery;
...
#[cfg(any())]
mod release_clears_safe_open_ownership_and_rejects_an_in_flight_delivery;
...
#[cfg(any())]
mod successor_supervisor_reconciles_a_stale_work_delivery_claim_before_reclaim;
