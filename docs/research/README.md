...
| --- | --- | --- |
| [AI-first multi-device Docs infrastructure](ai-first-multi-device-docs-infrastructure.md) | Future Docs service, revision, remote access, storage ADR, and Docs boundary for durable AgentMember/nested Team/unified Work | Active proposal; blocked on root-model ADR and PoC review |
