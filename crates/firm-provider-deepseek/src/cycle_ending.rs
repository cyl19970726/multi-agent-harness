//! Every way a DeepSeek cycle can end in `Err`, and its ADR 0076 mapping.
//!
...
pub(crate) enum DeepSeekCycleFailure {
    ...
    /// DSH runner stdout disconnected, the child exited, or the transport was
    /// already closed.
    TransportClosed,
