...
| `docs/design/execution-workbench-v4/team-war-room-works-closure-v1/visual-contract.json` | Team War Room Works browser, screenshot, responsive, and visual acceptance |
