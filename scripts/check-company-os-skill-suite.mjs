...
expect(
  skillContracts.includes("Docs, Work, and Finance dedicated CLI implemented; Org dedicated CLI planned"),
  "skill-contracts.md must distinguish implemented Docs/Work/Finance CLI from planned Org CLI",
);
...
expect(
  readme.includes("harness company org"),
  "Company OS README must keep Organization dedicated CLI planned",
);
...
const forbiddenAsImplemented = ["harness company org query"];
