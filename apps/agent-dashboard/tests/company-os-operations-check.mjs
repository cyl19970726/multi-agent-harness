...
async function main() {
  ...
  check(pages.includes('data-testid="standing-agent-chat-guidance"') && pages.includes("No approved action transport") && !pages.includes("standing-agent-message"), "Standing Agent shows an honest chat-guidance bar instead of a permanently disabled composer");
