# ADR 0031: Agent-operated Docs and code-declared pages

```text
state: active
date: 2026-07-24
supersedes: Notion-editor-first interpretation of Company OS Docs
depends_on: 0027-company-os-primary-model, 0029-agent-programmable-document-runtime, 0030-company-os-sql-read-model
```
...
- SQL remains a future derived read/query/index layer per ADR 0030. It does
