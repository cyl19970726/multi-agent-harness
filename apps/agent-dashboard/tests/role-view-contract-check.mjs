...
const observedRemoteFabric={company_id:"company-1",node_id:"node-1",state:"observed",gateway_session:{company_id:"company-1",node_id:"node-1",gateway_generation:2,node_daemon_id:"daemon-1",node_daemon_generation:3,control_plane_generation:4},outbox_depth:0,oldest_outbox_age_ms:0,inbox_depth:1,recovery_required:[],control_plane_metrics:{node_id:"node-1",administrative_status:"active",connection_status:"online",gateway_generation:2,control_plane_generation:4,certificate_expires_at_unix_ms:999,queued_operations:0,oldest_queued_age_ms:0,gateway_lease_age_ms:10,recovery_required_operations:[],last_assigned_route_seq:1,last_persisted_route_seq:1,reconcile_lag:0},store_revision:7};
