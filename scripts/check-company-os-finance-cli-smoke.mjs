...
async function main() {
  ...
  await post(base, "/v1/company-os/actors", admin({
    ...
    actor: {
      ...
      display_name: "Finance Governance Agent",
      ...
      capability_refs: ["company.records.write", "finance.commitment.write", "finance.payment.write"],
      permission_policy_refs: ["company.records.write", "finance.commitment.write", "finance.payment.write"],
      system_prompt_ref: "document-prompt-agent-finance-governance",
      tool_refs: ["tool-company-finance"],
      skill_refs: ["company-finance-operator"],
      accepted_work_types: ["finance"],
      escalation_policy_ref: "policy-finance-owner-escalation",
      runtime_refs: [],
      native_session_refs: [],
      created_at: NOW,
      updated_at: NOW,
