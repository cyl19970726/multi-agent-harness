...
page specs, hard layout specs, architecture, acceptance, and rejected
...
[pages/](pages/). Screenshot-verifiable implementation contracts live under
[hard-layout-specs/](hard-layout-specs/). Failed browser-visible attempts live
under [rejected-implementations/](rejected-implementations/). Architecture and
stack decisions stay in [frontend-architecture.md](frontend-architecture.md).
...
status:
  ...
  frontend_design_source: page specs + hard layout specs
...
- hard layout specs exist for the shell and every implementation slice;
...
6. Page specs under [pages/](pages/): product/UX contract per core page.
7. [frontend-architecture.md](frontend-architecture.md): technical stack,
   module boundaries, old-code disposition.
8. [hard-layout-specs/README.md](hard-layout-specs/README.md): implementation
   layout contract index.
9. Hard layout specs under [hard-layout-specs/](hard-layout-specs/): ASCII
   diagrams, first viewport, dimensions, scroll ownership, screenshot matrix.
10. [acceptance.md](acceptance.md): screenshot-first browser and PM/User gates.
...
| --- | --- | --- |
| `pages/*.md` | Page purpose, user question, canonical objects, workflow proof, IA, actions, failure modes. | CSS dimensions, exact ASCII region geometry, component internals. |
| `hard-layout-specs/*.md` | Desktop/tablet/mobile ASCII diagrams, first viewport, dimensions, scroll ownership, screenshot matrix. | Product semantics or why a page exists. |
...
If a hard layout change alters page meaning, update the page spec and
`layout-decisions.md` first. If it only changes dimensions, breakpoints, or
scroll ownership, update the hard layout spec.
...
page specs, architecture decision, and hard layout specs.
