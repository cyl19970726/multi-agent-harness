                    ...
                    "members": {
                        ...
                        "items": {
                            ...
                            "properties": {
                                ...
                                "provider_cwd_hint": {"type": "string", "minLength": 1, "description": "Optional exact member cwd. It may be the selected project root, an existing workspace, or a Git worktree sharing its git common directory. Host and Members may intentionally share one cwd; use a worktree only when the task needs isolation."},
