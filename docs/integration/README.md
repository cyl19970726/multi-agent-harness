...
| Kimi (Moonshot) | [kimi.md](kimi.md) · [ACP Team runtime](kimi-agent-team.md) | adapter implemented; installed 0.29.1 requires review | `kimi_acp` is the Team mode. The reviewed set contains 0.27.0; 0.29.1 remains `review_required` until protocol regeneration and a proportional live canary. |
