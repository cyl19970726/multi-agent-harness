...
fixtures["member-workbench"].data.agent_member={id:"member-fixture-1",display_name:"Fixture Member",description:"Exercises the local authenticated product loop.",role:"worker",organization_status:"active"};fixtures["member-workbench"].data.member_run={id:"member-run-fixture-1",agent_member_id:"member-fixture-1",team_run_id:"run-fixture-1",coordination_status:"active",runtime_status:"idle",runtime_generation:1,native_session_health:"available"};fixtures["member-workbench"].data.member_run_history=[fixtures["member-workbench"].data.member_run];fixtures["member-workbench"].data.my_works=[work];
