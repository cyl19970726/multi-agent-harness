...
fn callback_error(error: crate::CliError) -> harness_provider_pi::PiError {
...
pub(crate) struct PiTeamRuntime(harness_provider_pi::PiTeamRuntime);

impl PiTeamRuntime {
    pub(crate) fn new(client: harness_provider_pi::PiRpcClient) -> Self {
        Self(harness_provider_pi::PiTeamRuntime::new(client))
    }
}
...
impl rt::TeamRuntimeAdapter for PiTeamRuntime {
    ...
    fn capability_bindings() -> Vec<rt::CapabilityBinding> {
        harness_provider_pi::PiTeamRuntime::capability_bindings()
    }
    ...
    fn native_control<'a>(
        ...
        harness_provider_pi::PiTeamRuntime::native_control(close, interrupt)
    }
...
impl rt::RuntimeAdapter for PiTeamRuntime {
