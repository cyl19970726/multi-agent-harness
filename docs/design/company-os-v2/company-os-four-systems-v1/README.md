...
These diagrams explain the responsibility and collaboration boundaries between
Docs, Organization, Work, and Finance.

1. `four-system-responsibility-map--1536x1024.png` shows which system owns each
   kind of company truth and which requests cross the boundaries.
2. `trademark-operating-loop--1536x1024.png` applies the model to the first
