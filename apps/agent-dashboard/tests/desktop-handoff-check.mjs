...
const app=fs.readFileSync("apps/agent-dashboard/src/app/App.tsx","utf8");const vite=fs.readFileSync("apps/agent-dashboard/vite.config.ts","utf8");const main=fs.readFileSync("crates/firm-cli/src/main.rs","utf8");
