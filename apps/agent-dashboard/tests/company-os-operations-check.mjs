...
async function main() {
  ...
  check(pages.includes("<PageFrame dense") && components.includes('dense ? "py-4" : "py-7"') && components.includes('dense ? "mb-3 pb-3" : "mb-7 pb-5"'), "Organization opts into compact vertical rhythm without changing the default page frame");
