...
Workflow leaves are read-only by default: `writable=False` is the Starlark default (`crates/harness-workflow/src/starlark_front.rs:866`). A writable leaf may edit files and run shell, and it automatically isolates into a harness-owned throwaway git worktree (`crates/harness-workflow/src/lib.rs:70`, `crates/harness-workflow/src/lib.rs:72`, `crates/harness-cli/src/main.rs:7639`, `crates/harness-cli/src/main.rs:7641`, `crates/harness-cli/src/main.rs:7644`).
