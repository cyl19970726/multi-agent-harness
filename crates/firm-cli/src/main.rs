...
use harness_core::{
    ...
    ProviderRuntimeProjection, RegistryDeliveryAttempt, RegistryDeliveryStatus, RegistryMessage,
...
#[path = "main_modules/team_recovery_lane_blockers.rs"]
mod team_recovery_lane_blockers;
use team_recovery_lane_blockers::*;
