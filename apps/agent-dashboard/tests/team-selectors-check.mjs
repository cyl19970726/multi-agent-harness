...
function fixture() {
  return {
    ...
    works: [
      ...
      { id: "work-1", team_run_id: "run-1", title: "Implement selector", context_markdown: "Own the selector lane", completion_criteria_markdown: "Checks pass", phase: "active", condition: "normal", resolution: null, owner_member_id: "agent-a", active_member_run_id: "member-1", claim_mode: "host_assign", eligible_member_ids: [], prerequisite_work_ids: [], priority: "normal", artifact_refs: [], check_refs: [], version: 2, created_at: "2026-07-19T00:00:01Z", updated_at: "2026-07-19T00:00:03Z" },
      { id: "work-blocked", team_run_id: "run-1", title: "Blocked lane", context_markdown: "", completion_criteria_markdown: "Unblocked", phase: "active", condition: "blocked", resolution: null, owner_member_id: "agent-a", active_member_run_id: "member-1", claim_mode: "host_assign", eligible_member_ids: [], prerequisite_work_ids: [], priority: "urgent", artifact_refs: [], check_refs: [], version: 3, created_at: "2026-07-19T00:00:01Z", updated_at: "2026-07-19T00:00:04Z" },
      { id: "work-review", team_run_id: "run-1", title: "Review lane", context_markdown: "", completion_criteria_markdown: "Accepted", phase: "review", condition: "normal", resolution: null, owner_member_id: "agent-a", active_member_run_id: "member-1", claim_mode: "host_assign", eligible_member_ids: [], prerequisite_work_ids: [], priority: "high", artifact_refs: [], check_refs: [], version: 3, created_at: "2026-07-19T00:00:01Z", updated_at: "2026-07-19T00:00:04Z" },
      { id: "work-open-owned", team_run_id: "run-1", title: "Queued lane", context_markdown: "", completion_criteria_markdown: "Started", phase: "open", condition: "normal", resolution: null, owner_member_id: "agent-a", active_member_run_id: "member-1", claim_mode: "host_assign", eligible_member_ids: [], prerequisite_work_ids: [], priority: "normal", artifact_refs: [], check_refs: [], version: 1, created_at: "2026-07-19T00:00:01Z", updated_at: "2026-07-19T00:00:01Z" },
