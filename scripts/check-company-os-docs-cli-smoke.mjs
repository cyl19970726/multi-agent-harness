...
check(pageDefinitionSource.includes("candidate_package_recorded") && pageDefinitionSource.includes("does_not_switch_active_definition_pointer"), "Docs page publish records candidate package metadata without silently switching the active definition pointer");
