...
fn concurrent_cancellation_cannot_cross_remote_fact_admission_fence() {
    ...
    let (attestation, delegation, policy, _publication, operation) = current_remote_fact_fixture();
    ...
    let cancellation = std::thread::spawn(move || {
        ...
        let authority = harness_store::ResolvedCollaborationAuthority {
            ...
            source_work_application_service: cancellation_attestation.work_application_service_ref,
