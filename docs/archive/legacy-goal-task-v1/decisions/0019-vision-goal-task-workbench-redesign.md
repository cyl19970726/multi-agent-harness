...
[the archived Work Board design](../dashboard/work-board-design.md).
...
[0016](../../../decisions/0016-tailwind-shadcn-adoption.md)) to a **light, Notion-like document
...
- `docs/dashboard/pages/{vision-overview,goal-document,task-document,graph-kanban}.md`
  are superseded in part by [the archived Work Board design](../dashboard/work-board-design.md).
