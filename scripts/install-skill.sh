...
expand_suite() {
  case "$1" in
    company-os)
      echo "company-business-project-bootstrap dogfood-company-os connect-github-company-os company-docs-operator company-work-operator company-finance-operator company-org-operator company-module-designer company-page-builder"
      ;;
    *)
