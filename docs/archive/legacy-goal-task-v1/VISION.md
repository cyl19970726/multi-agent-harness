...
> [Company OS vision](../../company-os/vision.md), with Mission/Wave retained as the
> execution foundation by [ADR 0026](../../decisions/0026-mission-wave-architecture.md)
> and product scope decided by
> [ADR 0027](../../decisions/0027-company-os-primary-model.md). GoalPhase references
