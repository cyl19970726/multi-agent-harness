...
async function main() {
  ...
  check(pages.workspace.maintainers?.some((actor) => actor.id === "actor-agent-document-architecture" && actor.actorType === "Agent Membership"), "Docs workspace exposes projection-backed Agent Membership maintainers");
