...
const fixtures=Object.fromEntries(await Promise.all(["company-work","team-workspace","host-console","member-workbench","agent-workspace","operator"].map(async name=>[name,JSON.parse(await readFile(join(fixtureRoot,`${name}.json`),"utf8"))])));
