...
and attach both to its outcome. A Team Host can then cite those artifacts
and checks on the Work record's append-only WorkEvent lineage without inventing
a second internal plan or lifecycle.
