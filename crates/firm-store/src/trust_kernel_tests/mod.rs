...
mod deciding_native_session_reads_the_authority_not_the_projection;
mod drain_settlement_supersedes_in_flight_work_execution;
mod drained_session_resumes_under_the_next_daemon_generation;
mod driver_transfer_at_the_generation_ceiling_refuses_a_transfer_that_advanced_nothing;
mod host_cancel_preserves_provider_received_work_evidence;
mod host_recovers_lost_work_execution;
mod host_redelivers_open_work_after_member_close_and_reopen;
...
mod lost_work_live_requires_full_fence;
mod member_run_fixture;
mod native_session_bind_projects_both_copies_atomically;
...
mod predecessor_recovery_is_idempotent_across_daemon_generations;
mod recovery_cannot_confirm_applied_after_semantic_precondition_drift;
mod recovery_required_lane_resumes_only_after_reconciliation;
mod remote_message_persists_before_delivery_and_replays_without_route_duplication;
mod requested_is_a_decidable_predicate_not_prose;
...
mod runtime_command_prepared_before_native_bind_settles_after_it;
...
mod runtime_cycle_correlation_is_exact_and_idempotent;
...
mod single_aggregate_commit_is_unchanged_by_the_paired_generalization;
...
mod work_bound_before_first_open_is_claimable_after_native_session_attaches;
mod work_execution_binding_generation_fails_closed_at_the_ceiling;
mod work_execution_binding_rechecks_authoritative_dependency_readiness;
mod work_execution_close_cutover;
mod work_intake_is_independent_of_notifications;
mod work_journal_is_one_reader_across_both_journals;
...
mod predecessor_author_message_recovery;
