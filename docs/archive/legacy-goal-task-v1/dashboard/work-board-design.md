...
> follows the [Company OS frontend IA](../../../company-os/frontend-information-architecture.md),
> [ADR 0027](../../../decisions/0027-company-os-primary-model.md), and the retained
> Mission/Wave execution model in
...
[the archived ADR 0019](../decisions/0019-vision-goal-task-workbench-redesign.md).
...
Per [the current acceptance guidance](acceptance.md), screenshots must show:
