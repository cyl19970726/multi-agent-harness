...
fn assert_collaboration_env(
    ...
    for expected in [
        format!("FIRM_SPACE={project_id}"),
        format!("FIRM_PROJECT_ID={project_id}"),
        format!("FIRM_PROJECT={project_root}"),
        format!("FIRM_TEAM_RUN_ID={run_id}"),
        format!("FIRM_MEMBER_RUN_ID={member_id}"),
        "FIRM_WORK_ID=".to_string(),
    ] {
        assert!(
