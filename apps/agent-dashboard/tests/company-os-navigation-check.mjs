...
async function main() {
  ...
  try {
    ...
    check(contextUrl.includes("workItem=work-wcw-agentos-work-overview-ui") && contextUrl.includes("company=agent-company") && contextUrl.includes("space=agentos") && contextUrl.includes("project=star-harness") && contextUrl.includes("api=") && !contextUrl.includes("surface="), "selection sync preserves Company Store, Execution Space, Project Binding, and API context while omitting the default Work surface");
