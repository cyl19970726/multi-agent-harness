...
const runtimeTruth={work:{work_id:baseWork.work_id,phase:"active",condition:"normal",updated_at:"2026-08-12T08:00:00Z"},coordination:{state:"active",member_run_id:"member-run-mira",runtime_generation:3,runtime_status:"blocked"},harness_control:{state:"recovery_required",reason_code:"PROVIDER_IDLE_TIMEOUT",occurred_at:"2026-08-12T08:04:00Z",last_command:{id:"runtime-command-mira-1",command:"start_cycle",status:"recovery_required",updated_at:"2026-08-12T08:04:00Z",failure_code:"PROVIDER_IDLE_TIMEOUT"},next_action:"Resolve the exact RuntimeCommand from evidence; do not replay blindly."},provider_native_activity:{state:"observed",last_observed_at:"2026-08-12T09:04:00Z",observed_after_control_loss:true},explanation:"Harness control is recovery_required (PROVIDER_IDLE_TIMEOUT). Provider-native activity was observed afterward; it does not prove recovery or Work completion."};
